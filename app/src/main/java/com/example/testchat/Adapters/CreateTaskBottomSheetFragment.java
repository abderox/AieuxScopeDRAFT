...
import com.example.testchat.Views.Agenda;
...
public class CreateTaskBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public void setTaskId(int taskId, boolean isEdit, setRefreshListener setRefreshListener, Agenda activity) {
        this.taskId = taskId;
        this.isEdit = isEdit;
    ...
    private void createTask() {
        class saveTaskInBackend extends AsyncTask<Void, Void, Void> {
            ...
            protected void onPostExecute(Void aVoid) {
                ...
                Toast.makeText(getActivity(), "Your Reminder is been added", Toast.LENGTH_SHORT).show();
                dismiss();
